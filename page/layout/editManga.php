        ...
        <form action="menu/editManga.php?user=<?php echo $name ?>&manga=<?php echo $idManga ?>" method="post" enctype="multipart/form-data">
            <div class="mx-5 p-6">
                <?php foreach ($result2 as $x) { ?>
                    ...
                    <div class="relative">
                        <input type="text" value="<?php echo $x['chapter']; ?>" id="chapter" name="chapter" placeholder="" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border border-gray-600 appearance-none focus:ring-1 peer"><br>
